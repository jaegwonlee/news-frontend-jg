          ...
          <div>
            ...
            <div className="bg-zinc-800/50 rounded-lg p-2 md:p-4 border border-zinc-700 max-h-60 md:max-h-80 overflow-y-auto space-y-3">
              {uncategorizedArticles.length > 0 ? (
                  ...
                  <div
                    ...
                    <div className="flex-shrink-0">
                      <input
                        ...
                        className="h-5 w-5 rounded-sm text-red-500 bg-zinc-900 border-zinc-600 focus:ring-red-500 focus:ring-offset-0 focus:ring-2"
                      />
                    </div>
                ...
                <p className="text-center text-zinc-500 py-8">미분류된 기사가 없습니다.</p>
              )}
            </div>
          </div>
        </div>
