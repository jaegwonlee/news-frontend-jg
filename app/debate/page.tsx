    ...
    <div className="bg-background text-foreground min-h-screen">
      <main className="container mx-auto px-4 py-12">
        ...
        <header className="text-center mb-20">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-normal text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
            DEBATE ARENA
          </h1>
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
           ...
           <div className="mt-8">
            <button className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold px-6 py-3 rounded-full hover:from-blue-600 hover:to-purple-700 transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-500/30">
                <PenSquare size={20} />
        ...
        {featured && (
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-center border-b border-border pb-4 mb-8 uppercase tracking-widest">Main Event</h2>
